...
Three plants, one at a time: `randi` for the seeded generator, `PLAYABLE`
reordered, and the respawn clearing the persona — each red by name.

Local: unit 211 scripts / 1 800 tests / 1 792 passing / 32 477 assertions;
...
**Fifty-one criteria are deliberately unticked** — regenerated 2026-09-24, +2 for US-0100's late joiner and clone floor, both built and left unticked because nothing asserts them, each blocked by something real —
