...
>   US-0041 (2026-08-16):** the bake is a *build-time* operation, not a runtime
...
| Navmesh, navigation agents, steering | **Half done, US-0041.** The navmesh is **baked at build time and committed** — TDD-08 §7's "never rebaked at runtime" — closing a bake US-0012 ticked while its own note called it owed. 195 polygons; 2011 street points sampled, 17 uncovered; roofs, balcony and canal asserted excluded. **Placement landed here too** and a server logs `crowd placed: 78 NPCs across 62 anchors`. **The steering half is not started**: no agent on the NPC scene, nothing ticks a brain, and far-band path validity is blocked on US-0045's LOD bands |
