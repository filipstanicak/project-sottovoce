...
| **M5** Depth | **3 abilities** (`ABIL-WHISPERBOLT` deferred 2026-08-27 to pay for escape — `SCOPE_FENCE.md` OUT #18), scoring with all bonuses, **the escape verb**, HUD, results screen, audio events, **the match state machine (US-0079, moved from M6 on 2026-09-08)** | US-0064–0077 less US-0068, plus US-0079, US-0097, and US-0100–0103 (persona deal, dressed district, civilian test bots, the crowd walking apart) | — |
