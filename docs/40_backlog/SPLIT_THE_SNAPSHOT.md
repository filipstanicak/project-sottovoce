...
The 397-line Snapshot blocks the next match implementation increment. Separate
...
Dependency: unblocks US-0079; PR #213 edits planning documents independently.
...
exact SHA belong to the PR handoff. Implementation is pending.
