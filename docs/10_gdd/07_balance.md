...
| **Halfseen** `SCORE-HALFSEEN` | +50 | 0.5 | Suspicion 30–69 (**Noticed**) at initiation | **Added 2026-08-27 by the fidelity re-audit.** The ladder had a hole in the middle: `SCORE-SILENT` pays 200 at Anonymous, `SCORE-RECKLESS` pays 0 at Exposed, and **a kill at Noticed paid nothing either way** — so being glimpsed and being caught in the open scored identically, which is the one comparison the suspicion economy most needs to make. The reference pays its lowest rung here. **The number is the weakest-sourced in this table** and is recorded as such in TUNABLES; the *shape* — a positive floor — is what the audit established. Invariant 32 keeps it strictly between Silent and Reckless. |
| **Reckless** `SCORE-RECKLESS` | **0** | 0 | Suspicion ≥ 70 (Exposed) at initiation | **Neutralised 2026-08-26 from −50, ADR-0013. There is now no points penalty in the game.** The reference has none either: its enforcement is that a careless kill *earns less*, never that it costs. An Exposed kill here already forfeits Silent, Patient **and Halfseen** — 350 points — and a further −50 was punishment stacked on top of an enforcement that was already doing the work. **The event still fires and is still shown, at zero**, because the feed line saying *you were seen* is the half that teaches. |
