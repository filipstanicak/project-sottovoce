...
| Field | Value |
|---|---|
| **Status** | **void** — 2026-09-22, [ADR-0021](adr/ADR-0021-the-hunter-knows-the-face.md). The reference shows the target's picture from assignment; the crowd's protection is the clone system (M3), not a hidden persona, and hiding it made the hardest read in the game unlearnable until the lock performed it. The row below is the assumption as it stood. |
...
| ASM-0030 | Contract portrait unknown until a lock completes | **void** (ADR-0021, 2026-09-22) | — | — |
